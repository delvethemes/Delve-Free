...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Supreme Shortcodes Free', // The plugin name.
            'slug'               => 'SupremeShortcodesFree', // The plugin slug (typically the folder name).
            'source'             => 'http://supremewptheme.com/plugins/supreme-shortcodes/SupremeShortcodesFree.zip', // The plugin source.
		...
		array(
            'name'               => 'Delve Shortcodes',
            'slug'               => 'delve-shortcodes',
            'source'             => 'http://free.delvethemes.com/delve-shortcodes.zip',
            'required'           => true,
            'version'            => '',
